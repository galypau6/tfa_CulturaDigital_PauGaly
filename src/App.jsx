    ...
    <div className={`app ${limitedMode ? 'limited-mode' : ''}`}>
      ...
      {popupStep === 6 && (
        <>
          ...
          <button
            className={`calibration-point ${eyeStep === 1 ? "point-active" : "point-inactive"
              }`}
            style={{
              top: "80px",
              left: "80px"
          ...
          {/* PUNT SUPERIOR DRETA */}
          <button
            className={`calibration-point ${eyeStep === 2 ? "point-active" : "point-inactive"
              }`}
            style={{
              top: "80px",
              right: "80px"
          ...
          <button
            className={`calibration-point ${eyeStep === 3 ? "point-active" : "point-inactive"
              }`}
            style={{
              bottom: "80px",
              left: "80px"
          ...
          {/* PUNT INFERIOR DRETA */}
          <button
            className={`calibration-point ${eyeStep === 4 ? "point-active" : "point-inactive"
              }`}
            style={{
              bottom: "80px",
              right: "80px"
      ...
      {popupStep === 11 && (
        <div className="settings-panel">
          ...
          <div className="radio-group">
            ...
            <div
              className={`radio-option ${sleepHabit === "Abans de les 22:00" ? "selected-radio" : ""
                }`}
            ...
            <div
              className={`radio-option ${sleepHabit === "Entre les 22:00 i les 00:00" ? "selected-radio" : ""
                }`}
            ...
            <div
              className={`radio-option ${sleepHabit === "Entre les 00:00 i les 02:00" ? "selected-radio" : ""
                }`}
            ...
            <div
              className={`radio-option ${sleepHabit === "Després de les 02:00" ? "selected-radio" : ""
                }`}
      ...
      {popupStep === 13 && (
        <div className="settings-panel">
          ...
          <div className="team-grid">
            ...
            <div
              className={`team-card ${personalityType === "Analític" ? "selected-team" : ""
                }`}
            ...
            <div
              className={`team-card ${personalityType === "Creatiu" ? "selected-team" : ""
                }`}
            ...
            <div
              className={`team-card ${personalityType === "Competitiu" ? "selected-team" : ""
                }`}
            ...
            <div
              className={`team-card ${personalityType === "Sociable" ? "selected-team" : ""
                }`}
